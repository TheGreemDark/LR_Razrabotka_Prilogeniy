...
2. Инициализация БД: \`docker compose myproject-web-1 python init_db.py\`
3. Тест redis: \`docker exec myproject-web-1 python test_Dcash.py\`
4. Тест кэширования: \`docker exec myproject-web-1 python test_redis.py\`
