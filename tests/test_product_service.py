...
class TestOrderServiceWithMock:
    ...
    async def test_create_order_with_multiple_products(self):
        ...
        mock_user = Mock(id=1, email="u1@example.com", username="u1", first_name="U1", last_name="Test")
        ...
        mock_order = Mock(id=1, user_id=mock_user.id, address_id=mock_addr.id, products=[mock_p1, mock_p2])
        ...
        user = await service.user_repository.create(UserCreate(email="u1@example.com", username="u1", first_name="U1", last_name="Test"))
        p1 = await service.product_repository.create("Prod A", 1000, 10)
        p2 = await service.product_repository.create("Prod B", 2000, 5)
        order = await service.order_repository.create(user.id, mock_addr.id, [p1.id, p2.id])

        mock_user_repo.create.assert_awaited_once()
        mock_product_repo.create.assert_awaited()
        mock_order_repo.create.assert_awaited_once_with(user.id, mock_addr.id, [p1.id, p2.id])
    ...
    async def test_create_order_with_missing_product_ids(self):
        ...
        mock_order = Mock(id=2, user_id=mock_user.id, address_id=mock_addr.id, products=[mock_p1])
        ...
        user = await service.user_repository.create(UserCreate(email="u2@example.com", username="u2", first_name="U2", last_name="Test"))
        p1 = await service.product_repository.create("Prod C", 500, 3)
        order = await service.order_repository.create(user.id, mock_addr.id, [p1.id, 99999])

        mock_order_repo.create.assert_awaited_once_with(user.id, mock_addr.id, [p1.id, 99999])
        assert order is not None
    ...
    async def test_create_order_with_duplicate_product_ids(self):
        ...
        mock_order = Mock(id=3, user_id=mock_user.id, address_id=mock_addr.id, products=[mock_p1])
        ...
        user = await service.user_repository.create(UserCreate(email="u3@example.com", username="u3", first_name="U3", last_name="Test"))
        p1 = await service.product_repository.create("Prod D", 1500, 2)
        order = await service.order_repository.create(user.id, mock_addr.id, [p1.id, p1.id])

        mock_order_repo.create.assert_awaited_once_with(user.id, mock_addr.id, [p1.id, p1.id])
        assert order is not None
        assert len(order.products) == 1
        assert order.products[0].id == p1.id
    ...
    async def test_add_product_already_in_order(self):
        ...
        mock_order = Mock(id=4, user_id=mock_user.id, address_id=mock_addr.id, products=[mock_p1])
        ...
        user = await service.user_repository.create(UserCreate(email="u4@example.com", username="u4", first_name="U4", last_name="Test"))
    ...
    async def test_create_order_with_empty_products(self):
        ...
        mock_order = Mock(id=6, user_id=mock_user.id, address_id=mock_addr.id, products=[])
        ...
        user = await service.user_repository.create(UserCreate(email="u6@example.com", username="u6", first_name="U6", last_name="Test"))
    ...
    async def test_get_by_user(self):
        ...
        mock_order1 = Mock(id=7, user_id=mock_user.id, address_id=mock_addr.id, products=[mock_prod1])
        mock_order2 = Mock(id=8, user_id=mock_user.id, address_id=mock_addr.id, products=[mock_prod2])
        ...
        user = await service.user_repository.create(UserCreate(email="byuser@example.com", username="userA", first_name="UserA", last_name="Test"))
    ...
    async def test_get_by_id(self):
        ...
        mock_order = Mock(id=9, user_id=mock_user.id, address_id=mock_addr.id, products=[mock_prod1, mock_prod2])
        ...
        user = await service.user_repository.create(UserCreate(email="byid@example.com", username="userB", first_name="UserB", last_name="Test"))
    ...
    async def test_delete_order_by_id(self):
        ...
        mock_order = Mock(id=10, user_id=mock_user.id, address_id=mock_addr.id, products=[mock_prod])
        ...
        user = await service.user_repository.create(UserCreate(email="delorder@example.com", username="delU", first_name="Del", last_name="User"))
